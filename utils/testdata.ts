...
export const data = {
  ...
  product: {
    ...
    standard: {
      ...
      regularPrice: () =>
        faker.finance.amount(100, 200, faker.helpers.arrayElement([1, 2])),
  ...
  subscription: {
    ...
    subscriptionDeletePopupForm:
      'Are you sure want to delete subscription plan',
  ...
  teamSettings: {
    ...
    verified: 'Verified!',
    verifiedPageText:
      'You have to register first for accessing the admin dashboard.',
