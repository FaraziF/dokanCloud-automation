...
const basicAuth = (email: any, password: any) =>
...
export const payloads = {
  ...
  categoryUpdate: () => {
    return {
      name:
        faker.commerce.productAdjective() + faker.datatype.uuid() + ' update',
  ...
  saveSEOGeneral: () => {
    return {
      ...
      siteUrl: env('URL'),
      description:
        'Our sellers and their millions of amazing products help make Jamuna Future Park one of the fastest-growing eCommerce platforms in the World. Whether you’re a small business or a global brand, our innovative solutions simplify the selling experience and help deliver growth at scale. Let’s grow together!\n',
    };
  },
  saveSocialShare: () => {
    return {};
  ...
  vendorSaveBasicSettings: () => {
    return {
      ...
      about:
        '<p>Introducing our Elegant Versatility Midi Dress – a timeless piece designed to seamlessly transition from day to night with grace and style.</p>',
      banner: {
