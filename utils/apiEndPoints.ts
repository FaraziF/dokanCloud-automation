...
export const endPoints = {
  ...
  /* >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> All Sub URL <<<<<<<<<<<<<<<<<<<<<<<<<<<<< */
    ...
    searchBrand: (brandName: string) => `${catalogURL}/api/v1/brands?search=${brandName}`,
    ...
    searchProductCollections: (productCollectionName: string) => `${catalogURL}/api/v1/product-collections?search=${productCollectionName}`,
    editProductCollections:  (productCollectionID: string) =>  `${catalogURL}/api/v1/product-collections/${productCollectionID}`,
    deleteProductCollections:  (productCollectionID: string) =>  `${catalogURL}/api/v1/product-collections/${productCollectionID}`,
    ...
    getSingleOrder: (singleOrderID: string) => `${orderURL}/api/v1/admin/orders/${singleOrderID}`,
    searchOrder: (orderNo: number) => `${orderURL}/api/v1/admin/orders?include=orderGroup&filters[search]=${orderNo}`,
    updateShippingAddress: (singleOrderID: string) =>`${orderURL}/api/v1/admin/orders/${singleOrderID}/shipping`,
    updateBillingAddress: (singleOrderID: string) =>`${orderURL}/api/v1/admin/orders/${singleOrderID}/billing`,
    putOnHoldOrder:(singleOrderID: string) => `${orderURL}/api/v1/admin/orders/${singleOrderID}/on-hold`,
    removeHoldOrder:(singleOrderID: string) => `${orderURL}/api/v1/admin/orders/${singleOrderID}/remove-hold`,
    cancelOrder:(singleOrderID: string) => `${orderURL}/api/v1/admin/orders/${singleOrderID}/cancel`,
    
    getPaymentID: (singleOrderID: string) => `${paymentURL}/api/v1/orders/${singleOrderID}/payments`,
    createShipment: `${orderURL}/api/v1/shipments`,
    chargeOrder: (singleOrderID: string) => `${paymentURL}/api/v1/orders/${singleOrderID}/charges`,
    refundOrder: (singleOrderID: string) => `${orderURL}/api/v1/admin/orders/${singleOrderID}/refunds`,
    ...
    editCreatedSubscription: (subscriptionID: number) => `${userURL}/api/v1/subscriptions/plans/${subscriptionID}`,
    saveDraftSubscription: (subscriptionID: number) => `${userURL}/api/v1/subscriptions/plans/${subscriptionID}`,
    deleteCreatedSubscription:(subscriptionID: number) => `${userURL}/api/v1/subscriptions/plans/${subscriptionID}`,
    ...
    getSearchVendors: (vendorStoreName: any) => `${userURL}/api/v1/admin/vendors?filters[search]=${vendorStoreName}`,
    getPaginationVendors:`${userURL}/api/v1/admin/vendors?page=2`,
    getVendorIndividualProduct: (vendorID: any) => `${catalogURL}/api/v1/admin/products?filters[vendorId]=${vendorID}`,
    getIndividualVendor:(vendorID: any) => `${userURL}/api/v1/admin/vendors/${vendorID}`,
    editIndividualVendorGeneralSettings: (vendorID: any) => `${userURL}/api/v1/admin/vendors/${vendorID}/general`, // vendor.200 id: 6207
    getIndividualVendorSubscriptionSettings: (vendorID: any) => `${userURL}/api/v1/admin/vendors/${vendorID}`,
    editIndividualVendorAddressSettings: (vendorID: any) => `${userURL}/api/v1/admin/vendors/${vendorID}/address`,
    editIndividualVendorSocialSettings: (vendorID: any) => `${userURL}/api/v1/admin/vendors/${vendorID}/social`,
    ...
    editCreatedCustomer: (customerID: number) => `${userURL}/api/v1/admin/customers/${customerID}`,
    searchCustomer: (customerEmail: string) => `${userURL}/api/v1/admin/customers?search=${customerEmail}`,
    resetCreatedCustomer: (customerID: number) => `${userURL}/api/v1/admin/customers/${customerID}/password`,
    deactivatedCreatedCustomer: (customerID: number) => `${userURL}/api/v1/admin/customers/${customerID}`,
    markAsCustomer: (customerID: number) => `${userURL}/api/v1/users/${customerID}/mark-as-test`,
    unmarkAsCustomer: (customerID: number) => `${userURL}/api/v1/users/${customerID}/mark-as-test`,
    activateCustomer: (customerID: number) => `${userURL}/api/v1/admin/customers/${customerID}`,
   ...
   getMarketplaceMigrator: `${userURL}/api/v1/subscriptions/plans?filters[isFreePlan]=true&filters[status]=published`,
    ...
    searchPage: (pageName: string) => `${contentURL}/api/v1/pages?search=${pageName}`,
    ...
    searchTeamMember: (invitedTeamMemberEmail: string) => `${userURL}/api/v1/team/admin/members?search=${invitedTeamMemberEmail}`,
    editInvitedTeamMember: (invitedTeamMemberID: string) => `${userURL}/api/v1/team/admin/members/${invitedTeamMemberID}`,
    resendInvitationInvitedTeamMember: `${userURL}/api/v1/team/admin/invitations/resend`,
    removeInvitedNewTeamMember: (invitedTeamMemberEmail: string) => `${userURL}/api/v1/team/admin/invitations/${invitedTeamMemberEmail}`,
  ...
  getChoosePlans: `${userURL}/api/v1/admin/billing/plans`,
    ...
    addTaxCountry: (taxCountry: any) =>`${taxURL}/api/v1/tax/country/${taxCountry}/same`,
    manageSameTaxCountry: (sameTaxCountry: any) =>`${taxURL}/api/v1/tax/country/${sameTaxCountry}/same`,
    differentTaxCountry: (differentTaxCountry: any) =>`${taxURL}/api/v1/tax/country/${differentTaxCountry}`,
    getEditAllDifferentTaxCountry: (editAllTax: any) => `${taxURL}/api/v1/tax/country/${editAllTax}`,
    editStateTaxCountry: (editStateTax: any) => `${taxURL}/api/v1/tax/country/${editStateTax}`,
    deleteStateTaxCountry: (taxCountry: any, deleteState: any) =>`${taxURL}/api/v1/tax/country/${taxCountry}/state/${deleteState}`,
    deleteTaxCountry: (deleteTaxCountry: any) =>`${taxURL}/api/v1/tax/country/${deleteTaxCountry}`,
    addTaxClasses:`${taxURL}/api/v1/tax/classes`,
    renameTaxClasses: (taxClassID: number ) => `${taxURL}/api/v1/tax/classes/${taxClassID}`,
    deleteTaxClasses: (taxClassID: number ) => `${taxURL}/api/v1/tax/classes/${taxClassID}`,
 ...
 */
    ...
    individualProductGet: (product_id: string) => `${catalogURL}/api/v1/products/${product_id}`,
    searchIndividualProduct:(productTitle: string) => `${catalogURL}/api/v1/admin/products?search=${productTitle}`,
    createProduct: `${catalogURL}/api/v1/admin/products`,
    productUpdate: (productID: any) => `${catalogURL}/api/v1/admin/products/${productID}`,
    productDelete: (productID: string) => `${catalogURL}/api/v1/admin/products/${productID}`,
    ...
    getCategoryFilter: (category_id: string) => `${catalogURL}/api/v1/admin/products?filters[category]=${category_id}`,
    ...
    categoryDelete: (category_id: string) => `${catalogURL}/api/v1/categories/${category_id}`,
    categoryUpdate: (categoryID: string) => `${catalogURL}/api/v1/categories/${categoryID}`,
    ...
    vendorMarkAsTest: (vendorCreatorID: number) => `${dashboardURL}/api/v1/users/${vendorCreatorID}/mark-as-test`,
    ...
    vendorSearchIndividualProduct:(productTitle: string) => `${catalogURL}/api/v1/vendor/products?search=${productTitle}`,
    vendorCreateProduct: `${catalogURL}/api/v1/vendor/products`,
    vendorProductUpdate: (productID: any) => `${catalogURL}/api/v1/vendor/products/${productID}`,
    vendorProductDelete: (productID: any) => `${catalogURL}/api/v1/vendor/products/${productID}`,
    ...
    vendorGetSingleOrder: (singleOrderID: string) => `${orderURL}/api/v1/vendor/orders/${singleOrderID}`,
    vendorSearchOrder: (orderNo: number) => `${orderURL}/api/v1/vendor/orders?include=orderGroup&filters[search]=${orderNo}`,
    vendorUpdateShippingAddress: (singleOrderID: string) =>`${orderURL}/api/v1/vendor/orders/${singleOrderID}/shipping`,
    vendorUpdateBillingAddress: (singleOrderID: string) =>`${orderURL}/api/v1/vendor/orders/${singleOrderID}/billing`,
    vendorPutOnHoldOrder:(singleOrderID: string) => `${orderURL}/api/v1/vendor/orders/${singleOrderID}/on-hold`,
    vendorRemoveHoldOrder:(singleOrderID: string) => `${orderURL}/api/v1/vendor/orders/${singleOrderID}/remove-hold`,
    vendorCancelOrder:(singleOrderID: string) => `${orderURL}/api/v1/vendor/orders/${singleOrderID}/cancel`,
    
    vendorGetPaymentID: (singleOrderID: string) => `${paymentURL}/api/v1/orders/${singleOrderID}/payments`,
    vendorCreateShipment: `${orderURL}/api/v1/shipments`,
    vendorChargeOrder: (singleOrderID: string) => `${paymentURL}/api/v1/orders/${singleOrderID}/charges`,
    vendorRefundOrder: (singleOrderID: string) => `${orderURL}/api/v1/vendor/orders/${singleOrderID}/refunds`,
    ...
    vendorCreateShippingProfile: (shippingProfileID: string) => `${shippingURL}/api/v1/shipping/profiles/${shippingProfileID}/weight-rules`,
    vendorViewIndividualShippingProfile: (shippingProfileID: string) => `${shippingURL}/api/v1/shipping/vendor/profiles/${shippingProfileID}`,
    vendorUpdateIndividualShippingWeightRule: (shippingProfileID: string, weightRuleID: string) => `${shippingURL}/api/v1/shipping/profiles/${shippingProfileID}/weight-rules/${weightRuleID}`,
    ...
    getIndividualCoupon: (couponID: string) => `${couponURL}/api/v1/vendor/coupons/${couponID}`,
    searchCoupon: (coupon_title: string) => `${couponURL}/api/v1/vendor/coupons?search=${coupon_title}`,
    updateCoupon: (couponID: string) => `${couponURL}/api/v1/vendor/coupons/${couponID}`,
    deleteCoupon: (couponID: string) => `${couponURL}/api/v1/vendor/coupons/${couponID}`,
    ...
    vendorUpdateDefaultStoreAddress: (defaultAddressId: string) => `${userURL}/api/v1/vendor/addresses/${defaultAddressId}`,
    vendorAddNewLocation: `${userURL}/api/v1/vendor/addresses`,
    vendorUpdateLocation: (locationId: string) => `${userURL}/api/v1/vendor/addresses/${locationId}`,
    vendorDeleteLocation: (locationId: string) => `${userURL}/api/v1/vendor/addresses/${locationId}`,
    ...
    vendorSearchTeamMember: (invitedTeamMemberEmail: string) => `${userURL}/api/v1/team/vendor/members?search=${invitedTeamMemberEmail}`,
    vendorResendInvitationInvitedTeamMember: `${userURL}/api/v1/team/vendor/invitations/resend`,
    vendorRemoveInvitedNewTeamMember: (invitedTeamMemberEmail: string) => `${userURL}/api/v1/team/vendor/invitations/${invitedTeamMemberEmail}`,
    ...
    customerGetOrderDetails: `${orderURL}/api/v1/orders/${env('CUSTOMER_ORDER_ID')}`,
    ...
    customerEditNewAddresses: (customerID: number) => `${userURL}/api/v1/user/addresses/${customerID}`,
    customerDeleteNewAddresses: (customerID: number) => `${userURL}/api/v1/user/addresses/${customerID}`,
