export const selector = {
  ...
  product: {
    ...
    publishedPageElementValidation: 'PRICE',
    priceLocator: "(//th[@scope='col'])[4]",
    filter: "Filter",
    draftStatus: 'Draft',
  ...
  admin: {
    ...
    brand: {
      ...
      // save: "Update",
      dropDown: "(//div[@class='relative inline-block'])[1]",
    ...
    tax: {
      ...
      deleteLink:
        "(//button[contains(@class,'gap-2 shadow-sm')]/following-sibling::button)",
      ...
      addCountry:
        "//section[contains(@class,'flex flex-row-reverse')]//button[1]",

      sameTaxRate:
        'Same tax rate for entire country State, Province and Zip code of a country maintain a same tax rate.',
      taxName: 'Write here',
      ...
      differentTaxRate:
        'Different tax rate for state, city and zip Tax rate may varies upon State, Province, City and even Zip code.',
  ...
  registration: {
    ...
    countryOfCitizenship:
      'text=Country of citizenshipoption Afghanistan focused, 1 of 101. 101 results availabl >> input[role="combobox"]',
    countryOfBirthday:
      'text=Country of birthoption Afghanistan focused, 1 of 101. 101 results available. Use >> input[role="combobox"]',
    ...
    country:
      'text=Countryoption Afghanistan focused, 1 of 101. 101 results available. Use Up and D >> input[role="combobox"]',
    state:
      'text=Districtoption Bagerhat focused, 1 of 64. 64 results available. Use Up and Down  >> input[role="combobox"]',
